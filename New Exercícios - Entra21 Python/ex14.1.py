...
#    def salvar_arquivo(self, pessoa): # Alt
    ...
    def cadastrar_pessoa(self,): # Alt
        ...
        file.write(f"{p1.id};{p1.nome};{p1.data_nasc};{p1.cpf};{p1.telefone};{p1.email};{p1.endereco};{pergunta_secreta};{resposta};{senha};{letras_secretas}\n")
        file.close()
...
R: ''')
            ...
            if option_bank == '1':
                ...
                person = Nu.cadastrar_pessoa()
                
            elif option_bank == '2':
                print('Seu Cadastramento na NuConta irá Começar...\n')
                person = Vi.cadastrar_pessoa()
