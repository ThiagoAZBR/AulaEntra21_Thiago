...
tempo_emprestimo = int(input('Quantos meses deseja ter para pagar?'))
dinheiro_emprestado = 250.00
taxa_juros = 5.5

valor_receber = dinheiro_emprestado*(1+(taxa_juros/100))**tempo_emprestimo
print(f'Ficara com {tempo_emprestimo} meses e o valor que receberei será de R$:{valor_receber:.2f}')